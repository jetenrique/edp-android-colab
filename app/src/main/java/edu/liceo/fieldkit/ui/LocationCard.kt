...
fun LocationCard() {
    ...
    // TODO 11c: inside: if access is "None", set text to
    //           "Location denied. Allow it in Settings."
            ...
            Button(onClick = {
                ...
                if (access == "None") {
                    ...
                    context.currentLocation { loc ->
                        // TODO 12c: inside 12b, set text to the coordinates,
                        //           or to a message when loc is null
                        text = loc?.let {
